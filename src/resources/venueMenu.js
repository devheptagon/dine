...
import { Alert, Button, SafeAreaView, Platform, TextInput, View, Text, Image, ScrollView, TouchableOpacity, FlatList } from 'react-native';
...
export const VenueMenu = ({ navigation }) => {
    ...
    async function getMenuCategories(){
        ...
        let response = await fetch('https://cacloud.co.uk/api/dinelocal/menu/categories', { method: 'POST', headers: global.apiheader, body: data });
    ...
    return (
        <View style={{flex: 1, backgroundColor: 'white'}}>
            <Text style={{fontSize: 24, marginTop: 50, marginLeft: 20}}>Venue Menu</Text>
            <Button
