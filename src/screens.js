...
export const MyAccount = ({ navigation }) => {
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
            ...
            <Text style={{fontSize: 24, marginTop: 50, marginLeft: 20}}>My Account</Text>
...
export const VenueOffers = ({ navigation }) => {
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
            ...
            <Text style={{fontSize: 24, marginTop: 50, marginLeft: 20}}>Venue Offers</Text>
...
export const VenueAbout = ({ navigation }) => {
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
            ...
            <Text style={{fontSize: 24, marginTop: 50, marginLeft: 20}}>Venue About</Text>
...
export const VenueBasket = ({ navigation }) => {
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
            ...
            <Text style={{fontSize: 24, marginTop: 50, marginLeft: 20}}>Venue Basket</Text>
...
export const VenueBasketPay = ({ navigation }) => {
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
            ...
            <Text style={{fontSize: 24, marginTop: 50, marginLeft: 20}}>Venue Basket Pay</Text>
...
export const VenueBasketPayComplete = ({ navigation }) => {
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
            ...
            <Text style={{fontSize: 24, marginTop: 50, marginLeft: 20}}>Thank you for your order</Text>
